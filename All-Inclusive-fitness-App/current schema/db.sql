...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2024-03-11 05:08:32',NULL),('diagnostics.include_raw','OFF','2024-03-11 05:08:32',NULL),('ps_thread_trx_info.max_length','65535','2024-03-11 05:08:32',NULL),('statement_performance_analyzer.limit','100','2024-03-11 05:08:32',NULL),('statement_performance_analyzer.view',NULL,'2024-03-11 05:08:32',NULL),('statement_truncate_len','64','2024-03-11 05:08:32',NULL);
...
-- Dump completed on 2024-04-21 11:33:09
...
--
-- Table structure for table `caloriedata`
--

DROP TABLE IF EXISTS `caloriedata`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `caloriedata` (
  ...
  KEY `UserID` (`UserID`),
  CONSTRAINT `caloriedata_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `userprofile` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `caloriedata`
--

LOCK TABLES `caloriedata` WRITE;
/*!40000 ALTER TABLE `caloriedata` DISABLE KEYS */;
/*!40000 ALTER TABLE `caloriedata` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `lifts` (
  ...
  PRIMARY KEY (`lift_id`),
  KEY `UserID` (`UserID`),
  CONSTRAINT `lifts_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `userprofile` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `userprofile` VALUES (31,NULL,NULL,NULL,'joshuasmith','$2a$10$2F7uYri74Uyp9tBjgYEGG.5g113rC84Yt.fMS537NIq2U5CfZgXn.',NULL,NULL,'2024-04-16',NULL),(32,NULL,NULL,NULL,'colewiggin','$2a$10$WKwiJ/gqNoAUOLmN0T38COjI6gos6dVQGspvunhZdTDqE8GSviMrC',NULL,NULL,'2024-04-16',NULL),(33,NULL,NULL,NULL,'joshua123','$2a$10$8c35Dmc9.0odcnJFSErRQuQMIEztiFIBZ/yYIaK2uX/Sq6.7I8j3y',NULL,NULL,'2024-04-20',NULL),(34,NULL,NULL,NULL,'jason1','$2a$10$cSiut.cYoWa2PpXOa0tFpeeL8h8DEtvZ1QGLri7JD4QH/Y4IP9NUW',NULL,NULL,'2024-04-20',NULL),(35,NULL,NULL,NULL,'gunes1','$2a$10$vWSxW2TrFfWASCLsYx035e2IphT6h5XqaM6cKPsEQiWWyvixckr9a',NULL,NULL,'2024-04-20',NULL),(36,NULL,NULL,NULL,'gunes12','$2a$10$rbxTm5ZVBaqlKi5yyTJIm.N5pGLcA89dEtXHPTf7MkKafDWjFNawi',NULL,NULL,'2024-04-20',NULL);
/*!40000 ALTER TABLE `userprofile` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `weightupdates`
--

DROP TABLE IF EXISTS `weightupdates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `weightupdates` (
  `UserID` int DEFAULT NULL,
  `Weight` decimal(4,1) DEFAULT NULL,
  `UpdateDate` date DEFAULT NULL,
  `weight_id` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`weight_id`),
  KEY `fk_UserID_weight` (`UserID`),
  CONSTRAINT `fk_UserID_weight` FOREIGN KEY (`UserID`) REFERENCES `userprofile` (`user_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `weightupdates`
--

LOCK TABLES `weightupdates` WRITE;
/*!40000 ALTER TABLE `weightupdates` DISABLE KEYS */;
/*!40000 ALTER TABLE `weightupdates` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
